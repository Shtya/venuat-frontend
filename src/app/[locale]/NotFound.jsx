...
const NotFound = () => {
  ...
  return (
    <div className=" not-found min-h-[100vh] flex items-center justify-center   ">
      <div className="text-center">
        ...
        <div className="mt-6">
          <Button name={t("browse_halls")} href={"/available-halls"} dataAos={"fade-up"} width={"max-w-[400px] w-full mx-auto "} outline={true} />
        </div>
