...
export default function Page() {
    ...
    return (
        <div className='container py-[80px] !max-w-[900px] '>
            <h1 className='h0 mt-[50px] text-center mb-[20px] '>{loading ? t("necessaryLaws1") : t("necessaryLaws2") }</h1>
            ...
            {loading ? (
                ...
                <div
                    dangerouslySetInnerHTML={{
                        __html: data?.settings?.necessaryLaws?.[locale] || '<p>No content available</p>',
                    }}></div>
            )}
        </div>
    );
