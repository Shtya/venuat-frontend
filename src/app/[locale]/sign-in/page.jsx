...
export default function page() {
	...
	const { register, errors , trigger , clearErrors, setError, getValues, setValue, submit , watch, reset } = hookSignIn()
  ...
  return ( <LayoutAuth >
				<div className='max-w-[400px] w-full mx-auto max-md:mt-[0] ' >
					...
					<div className="flex items-center justify-center gap-[5px] my-[20px] ">
						...
						<Link data-aos="fade-up" href={SignUp} className='h4 text-primary1 underline cursor-pointer  ' > {t("createAccount")} </Link>
					</div>
					...
					<Button dataAos="fade-up" onClick={()=> submit()} name={t("loginButton")}  classname="mt-[40px]"  />
				</div>
  		</LayoutAuth> )
}
