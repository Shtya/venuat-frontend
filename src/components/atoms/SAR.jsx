...
export default function SAR({ price, cn }) {
    ...
    return (
        <span className='flex items-center gap-[2px] text-[15px] text-[#06275a]  font-[500] '>
            <span className={` ${cn} font-[700] ` }> {formattedPrice} </span>
            ...
            {/* <Image className='rtl:order-[1] w-[18px] ' src={'/assets/imgs/currency.png'} alt='' width={25} height={25} /> */}
        </span>
    );
}
