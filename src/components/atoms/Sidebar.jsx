...
export default function Sidebar({currentComponent ,handleCurrentPage}) {
  ...
  return (
	<div data-aos="fade-up" className='main-shadow h-fit pt-[20px] pb-[10px] border-[1px] border-[#D5DBF6] rounded-[20px] ' >
		<div className='mx-auto bg-primary3 hover:bg-opacity-50  duration-200 cursor-pointer rounded-[50%] flex items-center justify-center relative w-[80px] h-[80px] ' >
			...
			<label  htmlFor="upload" className='w-full  h-full flex items-center justify-center ' >
		...
		<div className="h3 text-center mt-[10px] ">  {t("nameValue")} </div>
		<div className="h4 text-center  text-secondry3 max-[300px]:hidden ">  {t("emailValue")} </div>
		...
		<hr className=' my-[10px] border-t-[1px] border-primary3 ' />
		<div onClick={()=> router.push("/sign-in") } className={`h4 p-[10px] text-red-600 hover:bg-red-200 cursor-pointer hover:bg-opacity-60 duration-200  `} > {t("logout")} </div>
