...
const RadioDate = ({ name, options , changeListen , selected, onChange , checkIn , checkOut , setDisabled }) => {
    ...
    if (allBooked) {
        return <span className='  absolute top-[-10px] rtl:left-0 ltr:right-0 inline-block px-4 py-2 text-sm font-normal text-gray-800 bg-gray-200 rounded-full border border-gray-300 '> {t("not-availabel")} </span>
    }
